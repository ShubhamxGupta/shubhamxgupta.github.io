...
export function ProjectCarousel() {
    ...
    return (
        <div
            className="relative w-full h-125 md:h-150 flex items-center justify-center overflow-visible perspective-distant py-12">
            {/* Navigation Buttons */}
            <button
                onClick={prevProject}
            ...
            {projectsData.map((project, index) => {
                ...
                return (
                    <motion.div
                        key={project.id}
                        className="absolute w-[85vw] md:w-112.5 h-125 md:h-137.5 bg-slate-900 border border-slate-700 rounded-3xl overflow-hidden shadow-2xl flex flex-col"
