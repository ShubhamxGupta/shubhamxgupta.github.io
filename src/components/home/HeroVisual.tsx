...
const CODE_LINES = [
    ...
    {text: "class", color: "text-purple-400"},
    {text: " ShubhamGupta", color: "text-yellow-300"},
    {text: "(", color: "text-slate-400"},
    ...
    {text: " =", color: "text-slate-400"},
    {text: " [", color: "text-slate-400"},
    {text: '"PyTorch"', color: "text-green-300"},
    {text: ", ", color: "text-slate-400"},
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Code Content */}
                <div
                    className="p-6 font-mono text-sm md:text-base leading-relaxed whitespace-pre overflow-x-auto overflow-y-auto max-h-[240px]">
              ...
              {chunk.text}
                ...
                {/* Shine Effect */}
                <div
                    className="absolute top-0 right-0 w-full h-full bg-gradient-to-bl from-white/5 to-transparent pointer-events-none"/>
            </motion.div>

            {/* Background Glow */}
            <div
                className="absolute top-1/2 right-20 -translate-y-1/2 w-[400px] h-[400px] bg-blue-500/20 blur-[100px] rounded-full -z-10"/>
        </motion.div>
    );
}
