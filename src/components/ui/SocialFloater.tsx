...
function SocialIcon({social}: { social: (typeof SOCIALS)[0] }) {
    ...
    return (
        ...
        >
            {/* Icon Container */}
            <div
                className="p-3 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md rounded-full shadow-lg border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 relative z-10 transition-colors duration-300 hover:text-blue-600 dark:hover:text-blue-400">
                <social.icon size={20}/>
            </div>
