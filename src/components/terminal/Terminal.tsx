            ...
            <AnimatePresence>
                {!isOpen && (
                    ...
                    >
                        ...
                        <span
                            className="absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-slate-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
              Open Terminal
            </span>
                    </motion.button>
                )}
            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        {/* Header */}
                        <div
                            className="flex items-center justify-between px-4 py-2 bg-slate-900 border-b border-slate-800 cursor-move">
