                ...
                <div className="max-w-5xl mx-auto grid gap-6">
                        ...
                        >
                            ...
                            >
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                                    <div
                                        className="flex items-center gap-4 text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">
                    <span className="flex items-center gap-1">
                      ...
                      <Clock size={12}/> {post.readTime}
                                    ...
                                    <span
                                        className="inline-flex text-xs font-bold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 px-2 py-1 rounded uppercase tracking-wide">
                    {post.tags[0]}
                  </span>
                                </div>
