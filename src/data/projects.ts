...
export const projectsData: Project[] = [
    {
        ...
        title: "GiftBound",
        description:
            "A modern Secret Santa event management application designed to simplify holiday gifting circles.",
        image: "/images/projects/giftbound.png",
        link: "https://giftbound.vercel.app/",
        github: "https://github.com/ShubhamxGupta/secretsanta",
    ...
    },
    {
        ...
        description:
            "A secure, client-side utility for generating WiFi QR codes, eliminating the need to share plain-text passwords.",
    ...
    },
    {
        ...
        description:
            "Interactive 3D puzzle engine featuring realistic physics and solver algorithms.",
    ...
    {
        id: "hug-bunny",
        title: "Hug Bunny Game",
        description:
            "A browser-based interactive game built with vanilla JS and Canvas API, featuring custom animation loops and responsive touch controls.",
        image: "/images/projects/hug-bunny.png",
        link: "/projects/hug-bunny-game/hug-bunny-game.html",
        tags: ["Game Dev", "Canvas", "Interactive"],
        techStack: ["Canvas API", "Vanilla JS", "HTML5"],
        problem:
            "Building smooth character animation and collision detection without a game engine.",
        outcome:
            "Delivered a playable browser game with frame-accurate animations and zero external dependencies.",
    },
    {
        id: "claw-machine",
        title: "Physics-Based Claw Machine",
        description:
            "A realistic arcade simulation focusing on physics fidelity and collision detection.",
        ...
        outcome:
            "Implemented custom collision constraints to mimic arcade mechanisim.",
    },
];
